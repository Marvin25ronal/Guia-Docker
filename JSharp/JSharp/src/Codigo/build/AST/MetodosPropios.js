...
var nombre = "proc marvin_201602520";
var MetodosPropios = /** @class */ (function () {
    function MetodosPropios() {
    }
    MetodosPropios.prototype.Construir = function () {
        var codigo = this.MetodoImprimirCadena();
    ...
    MetodosPropios.prototype.MetodoImprimirCadena = function () {
        var codigo = "\n";
        var indicet100 = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var indicet101 = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var etiqueta1 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var etiqueta2 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
    ...
    MetodosPropios.prototype.MetodoSumarCadenas = function () {
        var codigo = '\n';
        var inidice100 = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var inidice200 = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var inidice1100 = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var inidice2200 = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var inidicetnuevo = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var inidicetnuevo2 = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        ...
        var L3 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
    ...
    MetodosPropios.prototype.MetodoConvertirBooleanoString = function () {
        var codigo = '\n';
        var t1 = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var L0 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var tauxprimero = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
    ...
    MetodosPropios.prototype.MetodoConvertirDoubletoString = function () {
        var codigo = document.createTextNode('');
        var tentero = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tnumero = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tdecimal = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tref = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var taux = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var th = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var L0 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L1 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L2 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var presisi = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
    ...
    MetodosPropios.prototype.MetodoConvertirIntegertoString = function () {
        var codigo = "\n";
        var t1 = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tcontador = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tdef = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var torigen = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var th = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var taux = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var L0 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L1 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L2 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L3 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L4 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L5 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L6 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L7 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L8 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L9 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L10 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L11 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L12 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L100 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L101 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L200 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L201 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var Lsalida = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var salidaultima = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var tbandaera = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
    ...
    MetodosPropios.prototype.MetodoCambiarEnteroporchar = function () {
        var t100 = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var t101 = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var torigen = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var L0 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L1 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L2 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        ...
        var L9 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L10 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L306 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var Lfinal = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var codigo = '';
    ...
    MetodosPropios.prototype.MetodoPotencia = function () {
        var tbase = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var televar = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tresul = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var L0 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var Lprueba1 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var Lpruebafallida = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L1 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L2 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L3 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L4 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
    ...
    MetodosPropios.prototype.MetodoToEqualsString = function () {
        var ta = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tb = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var taux1 = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var taux2 = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tres = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var L0 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var SalidaA = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var SalidaB = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var incre = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var Falso = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var Iguales = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
    ...
    MetodosPropios.prototype.MetodoPrintEntero = function () {
        var ta = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var codigo = '\n';
    ...
    MetodosPropios.prototype.MetodoPrintDouble = function () {
        var ta = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var codigo = '\n';
    ...
    MetodosPropios.prototype.MetodoCrearArray = function () {
        var tvalor = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tref = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var L0 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var th = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var salida = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var codigo = document.createTextNode('\n');
        var tinicio = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
    ...
    MetodosPropios.prototype.MetodoLengthString = function () {
        var tcadena = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tcontador = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var taux = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var L0 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var salida = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
    ...
    MetodosPropios.prototype.MetodoToCharArray = function () {
        var tcadena = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var ttamcadena = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tposnuevoArray = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tpunteros = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var telementosnuevoarray = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tchar = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var L0 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var Salida = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var codigo = document.createTextNode('\n');
    ...
    MetodosPropios.prototype.MetodoToUpperCase = function () {
        var tcadena = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tnuevo = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var th = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tchar = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tnueva = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var L0 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var L1 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var nocambiar = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var meter = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var iterar = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var salida = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var codigo = document.createTextNode('\n');
    ...
    MetodosPropios.prototype.MetodoTolowerCase = function () {
        var tcadena = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tnuevo = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var th = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tchar = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
    ...
    MetodosPropios.prototype.MetodoLinial = function () {
        var tarr = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var ttam = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tnuevo = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tindinuevo = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tindiviejo = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tcontador = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var tvalor = VarGlobal_1.VarGlobal.getInstance().contadorTemporales;
        var L0 = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
        var salida = VarGlobal_1.VarGlobal.getInstance().contadorSaltos;
...
exports.MetodosPropios = MetodosPropios;
//# sourceMappingURL=MetodosPropios.js.map